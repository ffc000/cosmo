...
.modal-box{{background:#fff;border-radius:10px;padding:1.5rem;max-width:98vw;width:98vw;box-shadow:0 8px 32px rgba(0,0,0,.18);position:relative;overflow-x:auto}}
...
<div class="modal-overlay" id="modal-grafico-overlay" onclick="if(event.target===this)cerrarGrafico()">
  <div style="background:#fff;border-radius:10px;padding:1.5rem;max-width:98vw;width:98vw;box-shadow:0 8px 32px rgba(0,0,0,.18);position:relative">
