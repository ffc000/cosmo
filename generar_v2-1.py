...
Estilo: formal, t\u00e9cnico, espa\u00f1ol rioplatense. Sin markdown, sin t\u00edtulos."""
...
Transmisi\u00f3n: {datos['ult_trans']} transmitidos ({datos['ult_pct_trans']}), {datos['ult_no_trans']} no transmitidos ({datos['ult_pct_no_trans']}), {datos['ult_tardio']} tard\u00edos ({datos['ult_pct_tardio']})
  ...
  \u2014 Lastre: trans {datos['ult_pct_trans_last']}, no trans {datos['ult_pct_no_trans_last']}, tard\u00edo {datos['ult_pct_tardio_last']}
...
Estilo: formal, t\u00e9cnico, espa\u00f1ol rioplatense. Sin markdown extra, solo los t\u00edtulos en negrita indicados."""
...
def generar_informe(ruta_db, pais, anio, mes_d, mes_h, usar_ia, api_key, carpeta, log_fn):
    ...
    if usar_ia and api_key and ANT_OK:
        ...
        conclusion_ia=generar_conclusion_ia({
            ...
            "ult_pct_trans_last":pct(last_tr,ult_last_tot) if ult_last_tot else "N/D",
            "ult_pct_no_trans_last":pct(ult_last_tot-last_tr-n(impo_ult.get("tardio",0))-n(expo_ult.get("tardio",0)),ult_last_tot) if ult_last_tot else "N/D",
