...
# ── Blueprints ─────────────────────────────────────────────────────────────────
# Primer módulo extraído de app.py a la Fase 2 de profesionalización (separar
# los ~200 endpoints en módulos por área). Los siguientes: training, vua,
# senasa, finanzas — de a uno, corriendo los tests entre cada extracción.
...
@app.route("/api/garmin/historial_calendario")
@login_required
@modulo_required("training")
...
@app.route("/api/garmin/tendencias")
@login_required
@modulo_required("training")
def api_tendencias():
    """
...
@app.route("/api/garmin/actividades/<act_id>/detalle")
@login_required
@modulo_required("training")
