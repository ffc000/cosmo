...
.modal-box{{background:#fff;border-radius:10px;padding:1.5rem;max-width:760px;width:98%;box-shadow:0 8px 32px rgba(0,0,0,.18);position:relative}}
...
<div class="container" style="padding-top:0">
  <div style="background:#fff;border:1px solid #e5e7eb;border-radius:8px;padding:1.25rem;box-shadow:0 1px 3px rgba(0,0,0,.07)">
