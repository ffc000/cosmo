...
.modal-box{{background:#fff;border-radius:10px;padding:1.5rem;max-width:900px;width:96vw;box-shadow:0 8px 32px rgba(0,0,0,.18);position:relative;overflow-x:auto}}
