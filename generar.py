...
Rechazos del mes: total={datos['ult_rechazos']}, duplicados={datos['ult_rech_duplicados']}, operativos reales={datos['ult_rech_operativos']}. Usá EXACTAMENTE estos números. NO los sumes ni recalcules — si los sumás puede dar distinto por la forma en que se contabilizan.
...
def _generar_word(pais, anio, mes_d, mes_h, version,
    ...
    if conclusion_ia:
        ...
        for enc in ["# 3. Conclusiones y estado actual", "# CONCLUSIONES Y ESTADO ACTUAL",
