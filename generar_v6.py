...
Estilo: formal, t\u00e9cnico, espa\u00f1ol rioplatense. Sin markdown, sin t\u00edtulos. No repetir el nombre de la secci\u00f3n al inicio del texto. Evitar anglicismos (usar "desempe\u00f1o" en lugar de "performance", etc.).IMPORTANTE: usá EXACTAMENTE los porcentajes y números que te di. No recalcules ni redondees diferente."""
